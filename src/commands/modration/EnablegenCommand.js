...
module.exports = class EnablegenCommand extends BaseCommand {
  ...
  async run(client, message, args) {
    ...
    let embed = new Discord.MessageEmbed()
      .setTitle("Successfully Enabled Gen")
      .setDescription(`Gen Has Been Enabled. If You Use Gen Out Of #free-gen Channel You Get Blacklisted.`)
      .setTimestamp()
      .setColor("GREEN")
